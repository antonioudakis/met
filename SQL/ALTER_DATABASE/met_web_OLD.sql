...
5. Καταχωρώ στον πίνακα TABLESN τον επόμενο προς καταχώρηση σειριακό αριθμό που αφορά τον πίνακα MET;

INSERT INTO TABLESN VALUES ('ΜΕΤ',);

6. Δημιουργώ τον TRIGGER MET_INS_SN ο οποίος παίρνει τον επόμενο διαθέσιμο σειριακό αριθμό από τον πίνακα TABLESN για τον πίνακα MET;
...
7. Δημιουργώ τον πίνακα MET_WEB ο οποίος θα περιέχει τις εγγραφές εισαγωγής,διαγραφής και τροποποίησης του πίνακα MET;
...
8. Δημιουργώ τους TRIGGERS εισαγωγής,διαγραφής και τροποποίησης του πίνακα MET μέσω των οποίων θα καταχωρούνται οι εγγραφές στον πίνακα MET_WEB;
...
9. Πριν γίνει η ενέργεια 10 πρέπει να αφαιρέσω τους TRIGGERS από τον πίνακα METKARTL;
...
10. Προσθέτω στον πίνακα METKARTL την κολόνα METKARTL_SEQNO η οποία δείχνει το SEQNO της κάθε εγγραφής του πίνακα METKARTL;

ALTER TABLE METKARTL ADD METKARTL_SEQNO INTEGER;

11. Αποθηκεύω και εκτελώ την διαδικασία καταχώρησης σειριακών αριθμών METKARTL_SEQNO του πίνακα METKARTL;
...
12. Καταχωρώ στον πίνακα TABLESN τον επόμενο προς καταχώρηση σειριακό αριθμό που αφορά τον πίνακα METKARTL;

INSERT INTO TABLESN VALUES ('METKARTL',);

13. Δημιουργώ τον TRIGGER ο οποίος παίρνει τον επόμενο διαθέσιμο σειριακό αριθμό από τον πίνακα TABLESN και τον καταχωρεί στον πίνακα METKARTL;
...
14. Δημιουργώ τον πίνακα METKARTL_WEB ο οποίος θα περιέχει τις εγγραφές εισαγωγής, διαγραφής και μεταβολής του πίνακα METKARTL;
...
15. Δημιουργώ TRIGGERS εισαγωγής, διαγραφής και μεταβολής του πίνακα METKARTL μέσω των οποίων θα καταχωρούνται οι εγγραφές στον πίνακα METKARTL_WEB;
...
16. Πριν γίνει η ενέργεια 17 πρέπει να αφαιρέσω τους TRIGGERS από τον πίνακα METSTUPROG;
...
17. Προσθέτω στον πίνακα METSTUPROG την κολόνα METSTUPROG_SEQNO η οποία δείχνει το SEQNO της κάθε εγγραφής του πίνακα METSTUPROG;

ALTER TABLE METSTUPROG ADD METSTUPROG_SEQNO INTEGER;

18. Αποθηκεύω και εκτελώ την διαδικασία καταχώρησης σειριακών αριθμών METSTUPROG_SEQNO στις εγγραφές του πίνακα METSTUPROG;
...
19. Καταχωρώ στον πίνακα TABLESN τον επόμενο προς καταχώρηση σειριακό αριθμό που αφορά τον πίνακα METSTUPROG;

INSERT INTO TABLESN VALUES ('METSTUPROG',);

20. Δημιουργώ τον TRIGGER ο οποίος παίρνει τον επόμενο διαθέσιμο σειριακό αριθμό από τον πίνακα TABLESN για τον πίνακα METSTUPROG;
...
21. Δημιουργώ τον πίνακα METSTUPROG_WEB ο οποίος θα περιέχει τις εγγραφές εισαγωγής,διαγραφής και μεταβολής του πίνακα METSTUPROG; 
...
22. Δημιουργώ τους TRIGGERS εισαγωγής, διαγραφής και μεταβολής του πίνακα METSTUPROG μέσω των οποίων θα καταχωρούνται οι εγγραφές στον πίνακα METSTUPROG_WEB;
...
CREATE TRIGGER SYSADM.METSTUPROG_DEL  AFTER DELETE ON METSTUPROG
 ( EXECUTE INLINE 	( METSTUPROG.MITROO,METSTUPROG.PROGCODE,METSTUPROG.TMIMACODE,TOTBAU,DATEANAG,METSTUPROG_SEQNO)
  ...
  ACTIONS
    ...
    On Procedure Execute
      set MOD_TYPE = 'd'
      Call SqlPrepare( hSql , 'INSERT INTO METSTUPROG_WEB( MODIFTYPE,DATEMODIF,MITROO,PROGCODE,TMIMACODETOTBAU,DATEANAG,METSTUPROG_SEQNO)
       					  VALUES (:MOD_TYPE,SYSDATETIME,:sMITROO,:nPROGCODE, :nTMIMACODE, :nTOTBAU,:dDateAnag,:nMETSTUPROG_SEQNO)' )
      Call SqlExecute( hSql )
    On Procedure Close
      Call SqlDisconnect( hSql )
...
23. Καταχωρώ τις αρχικές εγγραφές των πινάκων MET_WEB, METKARTL_WEB, METSTUPROG_WEB;
