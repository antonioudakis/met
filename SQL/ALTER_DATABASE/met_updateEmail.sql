;=========================================================================;
1. Πριν γίνει η ενέργεια 2 πρέπει να αφαιρέσω τους TRIGGERS από τον πίνακα ΜΕΤ;
;=========================================================================;
...
;=========================================================================;
2.Τροποποιώ το μέγεθος της κολόνας email στον πίνακα ΜΕΤ;
;=========================================================================;
...
;=========================================================================;
3. Τροποποιώ το μέγεθος της κολόνας email στον πίνακα MET_IST ;
;=========================================================================;

ALTER TABLE MET_IST MODIFY EMAIL VARCHAR(50);
ALTER TABLE MET_IST ADD USRNAME VARCHAR(250);



;=========================================================================;
4. Τροποποιώ το μέγεθος της κολόνας email στον πίνακα MET_WEB ;
;=========================================================================;
...
;=========================================================================;
5. Δημιουγρώ τον TRIGGER MET_INS_SN ο οποίος παίρνει τον επόμενο διαθέσιμο
...
;==============================================================================;
8. Δημιουργώ τους TRIGGERS εισαγωγής, διαγραφής και τροποποίησης του πίνακα MET
    μέσω των οποίων θα καταχωρούνατι οι εγγραφές στον πίνακα MET_WEB και MET_IST;
;==============================================================================;
